...
<section class="hero">
  <div class="hero__slider-wrapper">
    <div class="wrapper hero__slick slick-carousel">

      <?php while(have_rows("hero_repeater")): the_row();?>

      <div class="hero__wrapper d-flex justify-content-center align-items-center row">
        ...
        ?>
            <a class="hero__btn btn" href="<?php echo esc_url($link_url); ?>"
  ...
  <div class="wrapper">
    <div class="hero__scroll">
      <div>Zjedź niżej</div>
      <img src="http://127.0.0.1:3000/orto4you2/wp-content/themes/candyweb-new/assets/imgs/arrow-down.svg" alt="Zjedź niżej" />
    </div>
  </div>
</section>
