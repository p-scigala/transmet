  ...
  <div class="wrapper">
    ...
    <div class="map__content">
      <?php if(get_field("map_link")): ?><a href="<?php echo get_field("map_link"); ?>" target="_blank"><?php endif; ?>
        <img class="map__img scroll-anim" src="../wp-content/themes/candyweb-new/assets/imgs/map.png" alt="Mapa" />
