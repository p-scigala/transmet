...
<form method="post" class="wc-auth-login">
	<p class="form-row form-row-wide input input__text">
	...
	<p class="wc-auth-actions">
		...
		<button type="submit" class="btn button button-large button-primary wc-auth-login-button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
