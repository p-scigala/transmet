...
<div class="u-columns col2-set my-my-account" id="customer_login">
  <div class="row">
    <div class="u-column1 col-12 col-lg-6">

      <?php endif; ?>

      <!-- <h2 class="my-account-title"><?php esc_html_e( 'Login', 'woocommerce' ); ?></h2> -->

      <form class="woocommerce-form woocommerce-form-login login" method="post">

        <?php do_action( 'woocommerce_login_form_start' ); ?>

        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide input input__text">
        ...
        <p class="form-row d-flex flex-column align-items-start">
          <label
            class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme mb-15">
    ...
    <div class="u-column2 col-12 col-lg-6">
      ...
      <h2 class="my-account-title"><?php esc_html_e( 'Register', 'woocommerce' ); ?></h2>
      ...
      <form method="post" class="woocommerce-form woocommerce-form-register register"
        ...
        <p class="woocommerce-form-row form-row">
          ...
          <button type="submit"
            class="btn custom-link woocommerce-Button woocommerce-button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?> woocommerce-form-register__submit"
            name="register"
            value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><span><?php esc_html_e( 'Register', 'woocommerce' ); ?></span></button>
        </p>
