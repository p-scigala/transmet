...
<li class="wc_payment_method payment_method_<?php echo esc_attr( $gateway->id ); ?>">
  ...
  <div>
    ...
    <label for="payment_method_<?php echo esc_attr( $gateway->id ); ?>">
      ...
      <img class="lazy-loaded payment-image-bacs bluemedia-przelewy-checkout"
        src="<?php echo get_template_directory_uri(); ?>/assets/imgs/icon-bank.svg" data-lazy-type="image"
        data-src="<?php echo get_template_directory_uri(); ?>/assets/imgs/icon-bank.svg">
    </label>
    <?php else:?>
    <label for="payment_method_<?php echo esc_attr( $gateway->id ); ?>">
      ...
      <img class="lazy-loaded payment-image-bacs"
        src="<?php echo get_template_directory_uri(); ?>/assets/imgs/icon-bank.svg" data-lazy-type="image"
        data-src="<?php echo get_template_directory_uri(); ?>/assets/imgs/icon-bank.svg">
      <?php else:?>
      <img class="lazy-loaded payment-image-bacs"
