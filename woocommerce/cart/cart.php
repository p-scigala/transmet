    ...
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
      <thead>
        <tr>
          ...
          <th class="product-price">Łącznie</th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr
              ...
              <div>
                <?php
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s">Usuń</a>',
          ...
          <td class="product-price" data-title="Łącznie">
            <?php
        ...
        <tr>
          <td colspan="3" class="actions">
            <div class="cart-actions">
              ...
              <div class="coupon">
                <label for="coupon_code">Posiadasz kupon? Wprowadź go poniżej:</label>
                <div>
